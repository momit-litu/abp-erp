				...
				<div class="page-title-heading">
					<div>
						<div class="page-title-head center-elem">
							...
							<span class="d-inline-block">Template Management</span>
						</div>
				...
				<table class="table table-bordered table-hover templates_table" id="templates_table" style="width:100% !important">
					<thead>
						<tr>
							...
							<th class="hidden-xs text-center" width="100">Status</th>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="form-title"><i class="fa fa-plus"></i> Add  New Template</h5>
			...
			<div class="modal-body">
				<div class="main-card mb-3 card">
					<div class="card-body">
						<form id="template_form" autocomplete="off" name="template_form" enctype="multipart/form-data" class="form form-horizontal form-label-left">
							@csrf
							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="form-row">
										<div class="col-md-12">
											<div class="form-row alert alert-info col-md-12" id='placeholders_main_div' style="display:none">
												<label class="">Placeholders</label>
												<div  id='placeholders_div'></div>
											</div>
										</div>
										<div class="col-md-12">
