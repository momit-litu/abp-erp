    ...
    <div class="modal-dialog modal-lg" role="document"> <!-- modal-lg-->
      <div class="modal-content">
        <div class="modal-header">
            <h2 class="modal-title" id="myModalLabelLg">Terms & Conditions</h2>
        </div>
          ...
          <div class="main-card mb-3 card">
            <div class="card-body" id="modalBodyLg">
                <div class=" col-md-12">
                    ...
                    <h3>How long we retain your data</h3><br>
                    ...
                    <h3>What rights you have over your data</h3><br>
