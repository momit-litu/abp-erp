							...
							<form id="general_setting" name="admin_user_form" enctype="multipart/form-data" class="form form-horizontal form-label-left">
								...
								<div class="row">
									...
									<div class="col-md-3 text-center">
										...
										<br><br>
										<img src="{{asset('assets/images/admin-upload/')}}/{{ ($setting['certificate_signeture']=="")?'no_images.png':$setting['certificate_signeture'] }}" width="70%" height="70%" class="img-thumbnail">
										<span class="btn btn-light-grey btn-file">
											<span class="fileupload-new"><i class="fa fa-picture-o"></i> Select Signeture</span>
											<input type="file" name="certificate_signeture" id="certificate_signeture" value="">
										</span>
									</div>
								</div>
								<div class="form-group">
