	...
	<div class="app-main__inner">
				...
				<div class="page-title-heading">
					<div>
						<div class="page-title-head center-elem">
							...
							<span class="d-inline-block">Dropout Report</span>
						</div>
		...
		<div class="main-card mb-3 card">
			<div class="card-body report-form">
				<form id="dropout_form" name="dropout_form" enctype="multipart/form-data" class="form form-horizontal form-label-left ba">
					@csrf
					<div class="form-row">	
							...
							<div class="position-relative form-group">
								...
								<div class="col-md-8">
									@if($actions['view_permisiion']>0)
										<button type="submit" id="show_dropout_status_report" class="btn btn-success btn-lg">Show</button>      
									</div>              
								@endif 
							</div>								
						</div>
		...
		<div class="main-card mb-3 card" >
			<div class="card-body" >
				<div id='report-data' style="display: none">
					<table class="table table-bordered table-hover dropout_table" id="dropout_table" style="width:100% !important"> 
						<thead>
							<tr>							
								<th>Course</th>		
