	...
	<div class="app-main__inner">
				...
				<div class="page-title-heading">
					<div>
						<div class="page-title-head center-elem">
							...
							<span class="d-inline-block">Certificate Report</span>
						</div>
		...
		<div class="main-card mb-3 card">
			<div class="card-body report-form">
				<form id="certificate_form" name="certificate_form" enctype="multipart/form-data" class="form form-horizontal form-label-left ba">
					@csrf
					<div class="form-row">	
							...
							<div class="position-relative form-group">
								...
								<div class="col-md-8">
									@if($actions['view_permisiion']>0)
										<button type="submit" id="show_certificate_status_report" class="btn btn-success btn-lg">Show</button>      
									</div>              
								@endif 
							</div>								
						</div>
