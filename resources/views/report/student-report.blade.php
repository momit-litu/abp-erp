					...
					<div class="form-row">							 
						...
						<div class="col-md-2"> 
							<div class="position-relative form-group">
								...
								<select class="form-control col-lg-10" id="type"  name="type" autocomplete="off">
						...
						<div class="col-md-2"> 
							<div class="position-relative form-group">
								...
								<select class="form-control col-lg-10" id="register_type"  name="register_type" autocomplete="off"> 
									<option value="All"  selected>All</option>
									<option value="Admin">Admin</option>
									<option value="Self" >Self</option>
								</select>
							</div>
								<select class="form-control col-lg-10" id="study_mode"  name="study_mode" autocomplete="off"> 
						</div> 
						<div class="col-md-1"> 
							<div class="position-relative form-group">
						...
						<div class="col-md-1"> 
							<div class="position-relative form-group"> 
								...
								<select class="form-control col-lg-10" id="status"  name="status" autocomplete="off"> 
									<option value="All"  selected>All</option>
