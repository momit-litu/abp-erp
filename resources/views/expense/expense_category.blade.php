				...
				<div class="page-title-heading">
					<div>
						<div class="page-title-head center-elem">
							...
							<span class="d-inline-block">Expense Category Management</span>
						</div>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="main-card mb-3 card">
					<div class="card-body">
						<form id="expense_category_form" name="expense_category_form" enctype="multipart/form-data" class="form form-horizontal form-label-left">
							@csrf
							<div class="row">
								<div class="col-md-12">
									...
									<div class="form-group">
										...
										<div class="col-md-12  col-xs-6">
											<input type="text" id="expense_category_name" name="expense_category_name" class="form-control col-lg-12" />
										</div>
									</div>
									<div class="form-group">
										<label class="control-label col-md-3 col-sm-3 col-xs-6" >Parent Category</label>
										<div class="col-md-12  col-xs-6">
											<select class="form-control col-lg-12"  name="parent_id" id="parent_id">
												<option value=""  selected>Select Category Name</option>
												@foreach($parentExpneseCategory as $parentCategory)
