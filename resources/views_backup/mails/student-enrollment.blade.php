          ...
          <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
            ...
            <tr>
              <td class="email-body" width="100%" cellpadding="0" cellspacing="0">
                <table class="email-body_inner" align="center" width="670" cellpadding="0" cellspacing="0" role="presentation">
                  <!-- Body content -->
                  <tr>
                        ...
                        <table class="discount" align="left" width="100%" cellpadding="0" cellspacing="0" role="presentation">
                          <tr>
                            <td align="left" style="text-align:left !important">
                              <h1 class="f-fallback discount_heading"  style="text-align:left !important">Enrollment Details:</h1>
                              ...
                              <p class="f-fallback discount_body"  style="text-align:left !important">Duration : {{$studentEnrollment['batch']['course']['programme_duration']}}</p>
                              <p class="f-fallback discount_body"  style="text-align:left !important">Appx. Start Date : {{$studentEnrollment['batch']['start_date']}}</p>                             
                              <p class="f-fallback discount_body"  style="text-align:left !important">Payment Plan : {{$studentEnrollment['batch_fee']['plan_name']}}</p>
                              <p class="f-fallback discount_body"  style="text-align:left !important">Course Fee : TK {{$studentEnrollment['total_payable']}}</p>
                            </td>
                          </tr>                         
                        </table>
