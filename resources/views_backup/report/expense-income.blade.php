				...
				<div class="page-title-heading">
					<div>
						<div class="page-title-head center-elem">
							...
							<span class="d-inline-block">Expense Vs Income Report</span>
						</div>
							...
							<div class="position-relative form-group">
								...
								<div class="col-md-8">
									@if($actions['view_permisiion']>0)
										<button type="submit" id="show_expense_income_report" class="btn btn-success btn-lg">Show</button>      
									</div>              
								@endif 
							</div>
						</div>
		...
		<div class="main-card mb-3 card" >
			<div class="card-body" >
				<div id='report-data' style="display: none">
					<table class="table table-bordered table-hover expense_income_table" id="expense_income_table" style="width:100% !important"> 
						<thead>
							<tr>
								<th>Serial</th>
								<th>Month </th>														
