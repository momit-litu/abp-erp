	...
	<div class="app-main__inner">
				...
				<div class="page-title-heading">
					<div>
						<div class="page-title-head center-elem">
							...
							<span class="d-inline-block">Payment Schedule Report</span>
						</div>
		...
		<div class="main-card mb-3 card">
			<div class="card-body report-form">
				<form id="collection_status_form" name="payment_schedule_status_form" enctype="multipart/form-data" class="form form-horizontal form-label-left ba">
					@csrf
					<div class="form-row">							 
						<div class="col-md-2">
							...
							<div class="position-relative form-group">
								...
								<div class="col-md-8">
									@if($actions['view_permisiion']>0)
										<button type="submit" id="show_payment_schedule_status_report" class="btn btn-success btn-lg">Show</button>      
									</div>              
								@endif 
							</div>								
						</div>
		...
		<div class="main-card mb-3 card" >
			<div class="card-body" >
				<div id='report-data' style="display: none">
					<table class="table table-bordered report-table-bordered table-hover payment_schedule_table " id="payment_schedule_table" style="width:100% !important"> 
						<thead>
							<tr>
								<th>Student</th>												
								<th>Course</th>										
