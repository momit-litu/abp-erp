...
<div class="main-login col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3">
    <div class="text-center col-lg-12" style="color: #fff; padding:20px">
      <image src="{{ asset('assets/images/logo.png')}}" />
    ...
    <!-- start: COPYRIGHT -->
    <div class="copyright">
        <span>© Copyright 2021. All Rights Reserved by Edupro Ltd.
    </div>
    <!-- end: COPYRIGHT -->
</div>
