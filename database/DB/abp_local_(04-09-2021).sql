...
INSERT INTO `batches` (`id`, `course_id`, `batch_name`, `start_date`, `end_date`, `fees`, `discounted_fees`, `student_limit`, `total_enrolled_student`, `details`, `running_status`, `status`, `featured`, `created_at`, `updated_at`) VALUES
	...
	(10, 9, '13', '2021-10-15', NULL, 60000, 55000, 30, 0, NULL, 'Upcoming', 'Active', 'No', '2021-07-08 14:31:13', '2021-07-08 14:31:13'),
	(11, 9, '14', '2022-01-01', NULL, 50000, 44000, 20, 2, NULL, 'Running', 'Active', 'Yes', '2021-07-08 18:50:31', '2021-07-12 08:21:31'),
	(12, 10, '01', '2021-09-01', '2022-08-31', 25000, 20000, 30, 2, NULL, 'Running', 'Active', 'Yes', '2021-07-14 15:28:26', '2021-08-18 10:57:17'),
	(13, 10, '045', '2021-08-29', '2021-09-29', 500000, 500000, 50, 0, NULL, 'Upcoming', 'Active', 'Yes', '2021-09-01 10:13:10', '2021-09-01 10:14:00');
...
-- Dumping data for table abpdb.batch_students: ~5 rows (approximately)
...
INSERT INTO `courses_units` (`id`, `unit_id`, `course_id`, `status`, `type`, `created_at`, `updated_at`) VALUES
	...
	(83, 23, 9, 'Active', 'Optional', '2021-08-01 05:41:34', '2021-08-01 05:41:34'),
	(84, 24, 9, 'Active', 'Optional', '2021-08-01 05:41:34', '2021-08-01 05:41:34');
...
-- Dumping data for table abpdb.notifications: ~1 rows (approximately)
/*!40000 ALTER TABLE `notifications` DISABLE KEYS */;
INSERT INTO `notifications` (`id`, `type`, `notifiable_type`, `notifiable_id`, `data`, `read_at`, `created_at`, `updated_at`) VALUES
	('0af64a02-3606-4b86-bfb4-7a12b8194edf', 'App\\Notifications\\duePaymentNotification', 'App\\Models\\User', 23, '{"Type":"Success","Message":" You have a due payment of TK 44000. Please make the payment."}', NULL, '2021-09-03 13:39:45', '2021-09-03 13:39:45'),
	('3e902fa6-4401-45a3-9bca-a5cdb60067e1', 'App\\Notifications\\duePaymentNotification', 'App\\Models\\User', 23, '{"Type":"Success","Message":" You have a due payment of TK 44000. Please make the payment."}', NULL, '2021-09-03 13:43:07', '2021-09-03 13:43:07'),
	('f5b02aad-f822-432b-b296-33b294ae909b', 'App\\Notifications\\duePaymentNotification', 'App\\Models\\User', 1, '{"Type":"Success","Message":" You have a due payment of TK 44000. Please make the payment."}', NULL, '2021-09-03 13:43:18', '2021-09-03 13:43:18');
...
INSERT INTO `settings` (`id`, `company_name`, `short_name`, `site_name`, `admin_email`, `admin_mobile`, `bkash_mobile_no`, `rocket_mobile_no`, `site_url`, `support_url`, `admin_url`, `logo`, `fade_logo`, `address`, `created_at`, `updated_at`) VALUES
	(1, 'ABPBD', 'ABPBD', 'ABPBD', 'admin@abpbd.com', '45455', '01980340482', '01980340482', NULL, 'support_url', NULL, 'logo-inverse.png', 'logo-fade.png', 'sdfsd f, sdf sdf', NULL, '2021-07-14 09:53:27');
...
-- Dumping data for table abpdb.students: ~8 rows (approximately)
...
-- Dumping data for table abpdb.student_documents: ~9 rows (approximately)
...
-- Dumping data for table abpdb.student_payments: ~11 rows (approximately)
...
-- Dumping data for table abpdb.users: ~10 rows (approximately)
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `email`, `user_profile_image`, `contact_no`, `remarks`, `student_id`, `status`, `type`, `login_status`, `password`, `email_verified_at`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 'Momit', 'Hasan', 'momit@technolife.ee', '1616308888.jpg', '74645564654', NULL, NULL, 1, 'Admin', 0, '$2y$10$zFj3Z1gRkrbgUvoNXF6cXubdAp8p54yy4kRgJ421RQNqllCEvHJka', NULL, NULL, '2021-06-07 12:50:15', '2021-09-04 02:15:24'),
	(23, 'Muniff', 'Hasannn', 'munif@gmail.com', '1630509972.jpg', '6546468', NULL, 21, 1, 'Student', 0, '$2y$10$KuzBDu8QI.9wk3PdzKq79uZ0qB68R/iSe4hoXUVE7pq2i5B0LREB2', NULL, NULL, '2021-06-21 09:46:55', '2021-09-01 16:38:33'),
...
-- Dumping data for table abpdb.user_group_members: ~17 rows (approximately)
