...
-- Dumping data for table abpdb.actions: ~35 rows (approximately)
...
-- Dumping data for table abpdb.expnese_categories: ~0 rows (approximately)
...
-- Dumping data for table abpdb.menus: ~16 rows (approximately)
...
INSERT INTO `menus` (`id`, `module_name`, `menu_title`, `menu_url`, `parent_id`, `serial_no`, `menu_icon_class`, `status`, `created_at`, `updated_at`) VALUES
	...
	(15, 'Qualifications', 'Qualifications', '', 0, 1, 'pe-7s-notebook', 1, '2021-03-21 06:57:45', '2021-03-21 06:57:45'),
	...
	(29, 'Expense Category', 'Expense Category', 'expense/expense-category', 28, NULL, NULL, 1, '2021-06-12 07:42:11', '2021-06-12 07:43:50');
...
-- Dumping structure for table abpdb.qualifications
...
-- Dumping data for table abpdb.qualifications: ~1 rows (approximately)
...
INSERT INTO `qualifications` (`id`, `level_id`, `code`, `title`, `tqt`, `total_credit_hour`, `registration_fees`, `status`, `created_at`, `updated_at`) VALUES
	(9, 1, 'Q2021001', 'PGDHRM', 600, 30, 500.00, 'Active', '2021-06-22 13:19:12', '2021-06-22 14:21:13');
/*!40000 ALTER TABLE `qualifications` ENABLE KEYS */;

-- Dumping structure for table abpdb.qualification_units
...
-- Dumping data for table abpdb.qualification_units: ~1 rows (approximately)
...
INSERT INTO `qualification_units` (`id`, `unit_id`, `qualification_id`, `status`, `type`, `created_at`, `updated_at`) VALUES
	(42, 23, 9, 'Active', 'Optional', '2021-06-22 14:21:13', '2021-06-22 14:21:13'),
	(43, 24, 9, 'Active', 'Optional', '2021-06-22 14:21:13', '2021-06-22 14:21:13');
...
-- Dumping data for table abpdb.students: ~1 rows (approximately)
...
INSERT INTO `students` (`id`, `first_name`, `last_name`, `email`, `contact_no`, `address`, `nid_no`, `date_of_birth`, `user_profile_image`, `remarks`, `status`, `created_at`, `updated_at`) VALUES
	(21, 'Muniff', 'Hasannn', 'munif@gmail.com', '6546468', 'dhaka', '123313131231', '2021-06-25', '', 'sdr fsfsfsdff', 'Active', '2021-06-21 09:46:55', '2021-06-21 10:02:27');
...
-- Dumping data for table abpdb.users: ~2 rows (approximately)
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `email`, `user_profile_image`, `contact_no`, `remarks`, `student_id`, `status`, `type`, `login_status`, `password`, `email_verified_at`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 'Momit', 'Hasan', 'momit@technolife.ee', '1616308888.jpg', '5555555555', 'erwerer', NULL, 1, 'Admin', 0, '$2y$10$mIW4VQ9btgEIsWKD6AnDeOD8ysMvPIQ7JQXFDmnYr35NpvXKlpHv2', NULL, 'DjMgP4X79N71SZ8s', '2021-06-07 12:50:15', '2021-06-23 11:52:53'),
...
-- Dumping data for table abpdb.user_group_members: ~5 rows (approximately)
...
-- Dumping data for table abpdb.user_group_permissions: ~84 rows (approximately)
