...
INSERT INTO `centers` (`id`, `code`, `name`, `short_name`, `address`, `proprietor_name`, `mobile_no`, `liaison_office`, `liaison_office_address`, `email`, `agreed_minimum_invoice`, `date_of_approval`, `date_of_review`, `approval_status`, `registration_fees`, `status`, `created_at`, `updated_at`) VALUES
	(5, '00001', 'BOGURA HUB', 'BOG', 'bogra', 'Momit', '01980340482', 'Dhaka', 'mdpur, Dhaka', 'momit.litu@gmail.com', 12000.00, '2021-03-23', '2021-03-21', 'Pending', 0.00, 'Active', '2021-03-23 09:46:38', '2021-03-29 05:10:46'),
...
-- Dumping data for table edupro.center_qualifications: ~5 rows (approximately)
...
INSERT INTO `center_qualifications` (`id`, `center_id`, `qualification_id`, `status`, `created_at`, `updated_at`) VALUES
	(49, 5, 1, 'Active', '2021-03-29 05:10:46', '2021-03-29 05:10:46'),
	(50, 5, 3, 'Active', '2021-03-29 05:10:46', '2021-03-29 05:10:46'),
	(51, 13, 1, 'Active', '2021-03-29 10:20:32', '2021-03-29 10:20:32'),
	(53, 15, 1, 'Active', '2021-03-29 10:32:15', '2021-03-29 10:32:15'),
	(55, 17, 1, 'Active', '2021-03-29 10:39:59', '2021-03-29 10:39:59');
...
INSERT INTO `menus` (`id`, `module_name`, `menu_title`, `menu_url`, `parent_id`, `serial_no`, `menu_icon_class`, `status`, `created_at`, `updated_at`) VALUES
	...
	(21, 'Cirtificates', 'Cirtificates', 'certificate', 0, 5, 'clip-target', 1, '2021-03-26 18:47:22', '2021-03-26 18:47:22');
...
-- Dumping data for table edupro.migrations: ~21 rows (approximately)
...
-- Dumping data for table edupro.registration_learners: ~8 rows (approximately)
...
INSERT INTO `registration_learners` (`id`, `learner_id`, `registration_id`, `pass_status`, `certificate_no`, `is_printd`, `result_claim_date`, `created_at`, `updated_at`) VALUES
	(1, 2, 8, 'No Result', '', 'No', NULL, NULL, NULL),
	...
	(18, 5, 19, 'No Result', '', 'No', NULL, NULL, '2021-03-26 18:27:11'),
	(19, 6, 19, 'Fail', '', 'No', NULL, NULL, '2021-03-26 18:27:36');
...
-- Dumping data for table edupro.units: ~8 rows (approximately)
...
-- Dumping data for table edupro.users: ~7 rows (approximately)
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `email`, `user_profile_image`, `contact_no`, `remarks`, `center_id`, `status`, `type`, `login_status`, `password`, `email_verified_at`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 'Momit', 'Hasan', 'momit@technolife.ee', '1616308888.jpg', '5555555555', 'erwerer', NULL, 1, 'Admin', 0, '$2y$10$mIW4VQ9btgEIsWKD6AnDeOD8ysMvPIQ7JQXFDmnYr35NpvXKlpHv2', NULL, NULL, NULL, '2021-03-29 10:19:16'),
	...
	(6, 'BOG', 'RA', 'momit.litu@gmail.com', NULL, '01980340482', 'cssdfsdfsdfdsf', 5, 1, 'Center', 0, '$2y$10$KwCQx44G9IAnA1JcCgkVoeKCkLWdXrJ0YxlbGoMRkVP0y//VzTJKW', NULL, NULL, '2021-03-23 09:46:38', '2021-03-29 11:11:12'),
	(8, 'GAIBANDHA', NULL, 'gaibandha@edupro.com', NULL, '01985045462', NULL, 13, 1, 'Admin', 0, '$2y$10$m3mRbgirMf5qNZmSpCanTeAcjd0eqD2J/DskSn2IQ5vgfd.gpWU7.', NULL, NULL, '2021-03-29 10:20:32', '2021-03-29 10:20:32'),
	(9, 'sdfsdfsdf', NULL, 'xcv@dfg.fg', NULL, '4254', NULL, NULL, 1, 'Admin', 0, '$2y$10$7yDgMcZ8SIiSG8BuACWdZOGU5dNoQcjFWS6Pu4QkUPrg7oP9lrAUy', NULL, NULL, '2021-03-29 10:32:15', '2021-03-29 10:32:15'),
	(11, 'Rangpur', NULL, 'rangpur@edupro.com', NULL, '01985045462', NULL, 17, 1, 'Center', 1, '$2y$10$ju7HT.p93v0q4.G5VpD0NOskfJ5zCV9nLJbz3mRrdSNHBZjxyUEqu', NULL, NULL, '2021-03-29 10:39:59', '2021-03-29 11:11:07');
...
-- Dumping data for table edupro.user_group_members: ~9 rows (approximately)
...
INSERT INTO `user_group_members` (`id`, `user_id`, `group_id`, `status`, `created_at`, `updated_at`) VALUES
	...
	(10, 9, 27, 1, '2021-03-29 10:32:15', '2021-03-29 10:32:15'),
