...
-- Dumping data for table abpdb.actions: ~55 rows (approximately)
...
INSERT INTO `actions` (`id`, `activity_name`, `module_id`, `is_menu`, `status`, `created_at`, `updated_at`) VALUES
	...
	(94, 'Send SMS', 40, 41, 1, '2021-08-24 13:50:25', '2021-08-24 13:50:25'),
...
-- Dumping data for table abpdb.batch_students: ~4 rows (approximately)
...
INSERT INTO `batch_students` (`id`, `batch_id`, `student_id`, `batch_fees_id`, `total_payable`, `total_paid`, `balance`, `status`, `created_at`, `updated_at`) VALUES
	...
	(35, 5, 21, 12, 52000.00, 0.00, 52000.00, 'Active', '2021-08-17 20:00:50', '2021-08-17 20:00:50'),
	(36, 12, 21, 24, 20000.00, 0.00, 20000.00, 'Inactive', '2021-08-18 10:57:17', '2021-08-18 10:57:17');
...
-- Dumping data for table abpdb.expenses: ~4 rows (approximately)
...
INSERT INTO `expenses` (`id`, `expense_head_id`, `amount`, `details`, `attachment`, `payment_status`, `status`, `created_at`, `updated_at`) VALUES
	...
	(7, 1, 5000.00, 'month of july', NULL, 'Paid', 'Active', '2021-07-15 14:21:57', '2021-07-15 14:21:57'),
	(8, 5, 150.00, 'sddfasdasd', NULL, 'Due', 'Active', '2021-08-04 05:32:07', '2021-08-04 05:32:07');
...
-- Dumping data for table abpdb.menus: ~23 rows (approximately)
...
INSERT INTO `menus` (`id`, `module_name`, `menu_title`, `menu_url`, `parent_id`, `serial_no`, `menu_icon_class`, `status`, `created_at`, `updated_at`) VALUES
	...
	(41, 'SMS', 'SMS', 'sms', 40, 1, NULL, 1, '2021-08-24 13:48:55', '2021-08-24 14:08:27'),
	(42, 'Email', 'Email', 'email', 40, 2, NULL, 1, '2021-08-24 13:49:19', '2021-08-24 13:49:19'),
...
INSERT INTO `settings` (`id`, `company_name`, `short_name`, `site_name`, `admin_email`, `admin_mobile`, `site_url`, `admin_url`, `logo`, `address`, `created_at`, `updated_at`) VALUES
	(1, 'ABPBD', 'ABPBD', 'ABPBD', 'admin@abpbd.com', '45455', NULL, NULL, 'logo-inverse.png', 'sdfsd f, sdf sdf', NULL, '2021-07-14 09:53:27');
...
-- Dumping data for table abpdb.students: ~4 rows (approximately)
...
INSERT INTO `students` (`id`, `name`, `student_no`, `email`, `contact_no`, `emergency_contact`, `address`, `nid_no`, `date_of_birth`, `user_profile_image`, `remarks`, `status`, `study_mode`, `type`, `register_type`, `registration_completed`, `current_emplyment`, `last_qualification`, `how_know`, `passing_year`, `created_at`, `updated_at`) VALUES
	(21, 'Muniff', '00500006', 'munif@gmail.com', '01980340482', '454', 'asdasds', '123313131231', '2021-06-25', '', 'sdr fsfsfsdff', 'Active', 'Online', 'Non-enrolled', 'Admin', 'Yes', 'dfsdf', 'Masters bachelor', 'From a Trainee of ABP', '2021-04-14', '2021-06-21 09:46:55', '2021-08-18 09:49:34'),
	(28, 'Muntakim hasan', '00500007', 'muntakim@gmail.com', '8646485', '78764453', 'dhaka', '6497846', '2021-07-28', '1625479466.jpg', ' sdf hfsdj fhsdkfh sdnfhkl sdf', 'Active', 'Online', 'Non-enrolled', 'Admin', 'Yes', NULL, 'Masters bachelor', 'From a Trainee of ABP', '2000-05-14', '2021-07-05 07:24:16', '2021-07-05 10:04:26'),
	(32, 'Litu', '00500008', 'litu@gmail.com', '646465', NULL, NULL, NULL, NULL, NULL, NULL, 'Active', 'Online', 'Non-enrolled', 'Admin', 'No', NULL, 'Masters bachelor', 'From a Trainee of ABP', NULL, '2021-08-16 15:37:45', '2021-08-16 15:37:45'),
	(33, 'Mounota Hasan', '00033', 'mounota@gmail.com', '654648864', '574646456', 'dhaka', '456456', '2021-07-20', '1629271136.jpg', NULL, 'Active', 'Online', 'Non-enrolled', 'Admin', 'Yes', 'Suvastu', 'Masters bachelor', 'From FaceBook', NULL, '2021-08-18 07:18:56', '2021-08-18 07:18:56');
...
INSERT INTO `student_payments` (`id`, `student_enrollment_id`, `installment_no`, `payable_amount`, `paid_amount`, `payment_status`, `paid_type`, `last_payment_date`, `paid_date`, `details`, `payment_refference_no`, `invoice_no`, `receive_status`, `attachment`, `created_at`, `updated_at`) VALUES
	...
	(55, 35, 1, 20000, 0, 'Paid', 'Cash', '2021-08-14', NULL, NULL, NULL, NULL, 'Not Received', NULL, '2021-08-17 20:00:50', '2021-08-17 20:00:50'),
	(56, 35, 2, 20000, 0, 'Unpaid', 'Cash', '2021-12-15', NULL, NULL, NULL, NULL, 'Not Received', NULL, '2021-08-17 20:00:50', '2021-08-17 20:00:50'),
	(57, 35, 3, 12000, 0, 'Unpaid', 'Cash', '2022-04-15', NULL, NULL, NULL, NULL, 'Not Received', NULL, '2021-08-17 20:00:50', '2021-08-17 20:00:50'),
	(58, 36, 1, 20000, 0, 'Unpaid', 'Cash', '2021-08-18', NULL, NULL, NULL, NULL, 'Not Received', NULL, '2021-08-18 10:57:17', '2021-08-18 10:57:17');
...
-- Dumping data for table abpdb.users: ~5 rows (approximately)
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `email`, `user_profile_image`, `contact_no`, `remarks`, `student_id`, `status`, `type`, `login_status`, `password`, `email_verified_at`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 'Momit', 'Hasan', 'momit@technolife.ee', '1616308888.jpg', '74645564654', NULL, NULL, 1, 'Admin', 0, '$2y$10$zFj3Z1gRkrbgUvoNXF6cXubdAp8p54yy4kRgJ421RQNqllCEvHJka', NULL, NULL, '2021-06-07 12:50:15', '2021-08-24 12:02:57'),
	(23, 'Muniff', 'Hasannn', 'munif@gmail.com', NULL, '6546468', 'sdr fsfsfsdff', 21, 1, 'Student', 1, '$2y$10$zFj3Z1gRkrbgUvoNXF6cXubdAp8p54yy4kRgJ421RQNqllCEvHJka', NULL, NULL, '2021-06-21 09:46:55', '2021-08-24 12:02:51'),
	...
	(28, 'Litu', NULL, 'litu@gmail.com', NULL, '646465', NULL, 32, 1, 'Student', 1, '$2y$10$5Z7y7Bt1TDrjp.mtolCSBu.MOayoHhvtMQmLIPV6eLywYVo2XtGGy', NULL, NULL, '2021-08-16 15:37:45', '2021-08-18 13:45:07'),
...
-- Dumping data for table abpdb.user_group_members: ~8 rows (approximately)
...
-- Dumping data for table abpdb.user_group_permissions: ~202 rows (approximately)
