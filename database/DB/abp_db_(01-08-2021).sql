...
-- Dumping data for table abpdb.actions: ~54 rows (approximately)
...
INSERT INTO `batches` (`id`, `course_id`, `batch_name`, `start_date`, `end_date`, `fees`, `discounted_fees`, `student_limit`, `total_enrolled_student`, `details`, `running_status`, `status`, `featured`, `created_at`, `updated_at`) VALUES
	(5, 9, '12', '2021-08-15', NULL, 50000, 48000, 20, 0, 'some details', 'Upcoming', 'Active', 'No', '2021-07-08 14:07:47', '2021-07-08 14:07:47'),
	(10, 9, '13', '2021-10-15', NULL, 60000, 55000, 30, 0, NULL, 'Upcoming', 'Active', 'No', '2021-07-08 14:31:13', '2021-07-08 14:31:13'),
	(11, 9, '14', '2022-01-01', NULL, 50000, 44000, 20, 2, NULL, 'Upcoming', 'Active', 'Yes', '2021-07-08 18:50:31', '2021-07-12 08:21:31'),
	(12, 10, '01', '2021-09-01', '2022-08-31', 25000, 20000, 30, 1, NULL, 'Upcoming', 'Active', 'Yes', '2021-07-14 15:28:26', '2021-07-14 15:28:50');
...
INSERT INTO `batch_students` (`id`, `batch_id`, `student_id`, `batch_fees_id`, `total_payable`, `total_paid`, `balance`, `status`, `created_at`, `updated_at`) VALUES
	...
	(34, 12, 28, 25, 20000.00, 15000.00, 5000.00, 'Active', '2021-07-14 15:28:50', '2021-07-16 12:15:08');
...
-- Dumping data for table abpdb.student_payments: ~7 rows (approximately)
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `email`, `user_profile_image`, `contact_no`, `remarks`, `student_id`, `status`, `type`, `login_status`, `password`, `email_verified_at`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 'Momit', 'Hasan', 'momit@technolife.ee', '1616308888.jpg', '74645564654', NULL, NULL, 1, 'Admin', 0, '$2y$10$zFj3Z1gRkrbgUvoNXF6cXubdAp8p54yy4kRgJ421RQNqllCEvHJka', NULL, NULL, '2021-06-07 12:50:15', '2021-08-01 05:38:45'),
	(23, 'Muniff', 'Hasannn', 'munif@gmail.com', NULL, '6546468', 'sdr fsfsfsdff', 21, 1, 'Student', 1, '$2y$10$zFj3Z1gRkrbgUvoNXF6cXubdAp8p54yy4kRgJ421RQNqllCEvHJka', NULL, NULL, '2021-06-21 09:46:55', '2021-08-01 05:38:38'),
	(24, 'Muntakim hasan', NULL, 'muntakim@gmail.com', '1625479466.jpg', '8646485', 'sdf hfsdj fhsdkfh sdnfhkl sdf', 28, 1, 'Student', 0, '$2y$10$zFj3Z1gRkrbgUvoNXF6cXubdAp8p54yy4kRgJ421RQNqllCEvHJka', NULL, NULL, '2021-07-05 07:24:16', '2021-07-16 17:30:57');
...
-- Dumping data for table abpdb.user_group_permissions: ~198 rows (approximately)
