...
-- Dumping data for table abpdb.actions: ~64 rows (approximately)
...
-- Dumping data for table abpdb.batches: ~4 rows (approximately)
/*!40000 ALTER TABLE `batches` DISABLE KEYS */;
INSERT INTO `batches` (`id`, `course_id`, `batch_name`, `start_date`, `end_date`, `fees`, `discounted_fees`, `student_limit`, `total_enrolled_student`, `details`, `running_status`, `status`, `featured`, `created_at`, `updated_at`) VALUES
	(5, 9, '12', '2021-08-15', NULL, 50000, 48000, 20, 1, 'some details', 'Upcoming', 'Active', 'No', '2021-07-08 14:07:47', '2021-08-17 20:00:50'),
	(10, 9, '13', '2021-10-15', NULL, 60000, 55000, 30, 5, NULL, 'Upcoming', 'Active', 'No', '2021-07-08 14:31:13', '2021-09-15 01:26:52'),
	(11, 9, '14', '2022-01-01', NULL, 50000, 44000, 20, 6, NULL, 'Running', 'Active', 'No', '2021-07-08 18:50:31', '2021-09-15 02:04:22'),
	(12, 10, '01', '2021-09-01', '2022-08-31', 25000, 20000, 30, 6, NULL, 'Running', 'Active', 'Yes', '2021-07-14 15:28:26', '2021-09-18 06:34:20'),
	(13, 10, '045', '2021-08-29', '2021-09-29', 500000, 500000, 50, 0, NULL, 'Upcoming', 'Active', 'No', '2021-09-01 10:13:10', '2021-09-01 10:14:00');
...
-- Dumping data for table abpdb.batch_students: ~11 rows (approximately)
/*!40000 ALTER TABLE `batch_students` DISABLE KEYS */;
INSERT INTO `batch_students` (`id`, `batch_id`, `student_id`, `batch_fees_id`, `student_enrollment_id`, `total_payable`, `total_paid`, `balance`, `status`, `created_at`, `updated_at`) VALUES
	(25, 11, 28, 21, '', 48000.00, 0.00, 48000.00, 'Active', '2021-07-09 12:47:15', '2021-07-14 19:48:04'),
	(33, 11, 21, 20, '', 44000.00, 44000.00, 0.00, 'Active', '2021-07-12 08:21:31', '2021-07-15 14:37:59'),
	(34, 12, 28, 25, '', 20000.00, 15000.00, 5000.00, 'Inactive', '2021-07-14 15:28:50', '2021-08-16 15:51:51'),
	(35, 5, 21, 12, '', 52000.00, 32000.00, 20000.00, 'Active', '2021-08-17 20:00:50', '2021-09-02 17:10:23'),
	(36, 12, 21, 24, '', 20000.00, 20000.00, 0.00, 'Active', '2021-08-18 10:57:17', '2021-09-02 02:40:58'),
	(39, 11, 38, 21, 'GDF01001f', 50000.00, 50000.00, 0.00, 'Active', '2021-09-08 01:55:51', '2021-09-08 07:08:05'),
	(40, 11, 38, 24, '', 20000.00, 0.00, 20000.00, 'Inactive', '2021-09-13 14:35:43', '2021-09-13 14:35:43'),
	(45, 10, 42, 18, 'HRM13002', 55000.00, 55000.00, 0.00, 'Active', '2021-09-15 01:26:52', '2021-09-15 01:54:04'),
	(46, 11, 42, 20, 'HRM14002', 44000.00, 44000.00, 0.00, 'Active', '2021-09-15 02:01:36', '2021-09-15 02:02:24'),
	(47, 11, 39, 20, 'HRM14003', 44000.00, 44000.00, 0.00, 'Active', '2021-09-15 02:04:22', '2021-09-15 02:05:37'),
	(49, 12, 42, 24, 'GDF01001', 20000.00, 20000.00, 0.00, 'Active', '2021-09-15 02:52:27', '2021-09-15 03:07:06'),
	(50, 12, 38, 24, 'GDF01002', 20000.00, 20000.00, 0.00, 'Active', '2021-09-18 06:34:20', '2021-09-18 06:57:14');
...
-- Dumping data for table abpdb.migrations: ~6 rows (approximately)
...
-- Dumping data for table abpdb.notifications: ~75 rows (approximately)
...
-- Dumping data for table abpdb.notification_templates: ~0 rows (approximately)
/*!40000 ALTER TABLE `notification_templates` DISABLE KEYS */;
INSERT INTO `notification_templates` (`id`, `title`, `details`, `type`, `created_at`, `updated_at`) VALUES
	(1, 'Payment due sms', 'Hello [student_name],\r\nYour payment [payment_amount] is due from [payment_date]. Please clear the payment as soon as possible.\r\nThank you\r\nABP', 'SMS', '2021-08-24 18:36:30', '2021-08-24 18:36:31');
...
INSERT INTO `settings` (`id`, `company_name`, `short_name`, `site_name`, `admin_email`, `admin_mobile`, `bkash_mobile_no`, `rocket_mobile_no`, `site_url`, `support_url`, `admin_url`, `logo`, `fade_logo`, `address`, `created_at`, `updated_at`) VALUES
	(1, 'Academy Of Business Professionals', 'ABPBD', 'ABPBD', 'admin@abpbd.com', '45455', '01980340482', '01980340482', NULL, 'support_url', NULL, 'abp.png', 'logo-fade.png', 'sdfsd f, sdf sdf', NULL, '2021-09-17 02:08:04');
...
-- Dumping data for table abpdb.students: ~12 rows (approximately)
/*!40000 ALTER TABLE `students` DISABLE KEYS */;
INSERT INTO `students` (`id`, `name`, `student_no`, `email`, `contact_no`, `emergency_contact`, `address`, `nid_no`, `date_of_birth`, `user_profile_image`, `remarks`, `status`, `study_mode`, `type`, `register_type`, `registration_completed`, `current_emplyment`, `last_qualification`, `how_know`, `passing_year`, `created_at`, `updated_at`) VALUES
	...
	(32, 'Litu', '00500008', 'litu@gmail1.com', '646465', NULL, NULL, NULL, NULL, NULL, NULL, 'Active', 'Online', 'Enrolled', 'Admin', 'No', NULL, 'Masters bachelor', 'From a Trainee of ABP', NULL, '2021-08-16 15:37:45', '2021-08-16 15:37:45'),
	...
	(38, 'Maariz Hasan', '00038', 'maariz@gmail.com', '323213133', '89745645', 'dhaka', '465545', '2022-09-15', '1631945533.jpg', NULL, 'Active', 'Online', 'Non-enrolled', 'Self', 'Yes', 'Suvastu', 'Bachelor\'s', 'From a Trainee of ABP', '2021-07-08', '2021-09-08 01:45:47', '2021-09-18 06:34:17'),
	...
	(40, 'nnnn', '008040', 'nn@nn.nn', '6465465', NULL, NULL, NULL, NULL, NULL, NULL, 'Active', 'Online', 'Non-enrolled', 'Self', 'Yes', NULL, 'Masters bachelor', 'From a Trainee of ABP', NULL, '2021-09-14 12:14:56', '2021-09-14 12:28:24'),
...
CREATE TABLE IF NOT EXISTS `student_payments` (
  ...
  `paid_type` enum('Cash','SSL','Bkash','Rocket') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'Cash',
...
-- Dumping data for table abpdb.student_payments: ~19 rows (approximately)
...
INSERT INTO `student_payments` (`id`, `student_enrollment_id`, `installment_no`, `payable_amount`, `paid_amount`, `payment_status`, `paid_type`, `last_payment_date`, `paid_date`, `details`, `payment_refference_no`, `invoice_no`, `receive_status`, `attachment`, `created_at`, `updated_at`) VALUES
	...
	(50, 34, 2, 5000, 0, 'Unpaid', 'Cash', '2022-03-01', NULL, NULL, NULL, NULL, 'Not Received', NULL, '2021-07-14 15:28:50', '2021-07-15 14:44:59'),
	(54, 34, 3, 4000, 4000, 'Paid', 'Cash', '2021-11-26', '2021-11-26', NULL, NULL, 'INV-000011', 'Received', NULL, '2021-07-15 14:44:51', '2021-07-16 18:13:17'),
	(55, 35, 1, 20000, 20000, 'Paid', 'Cash', '2021-08-14', '2021-08-31', NULL, NULL, NULL, 'Not Received', NULL, '2021-08-17 20:00:50', '2021-08-17 20:00:50'),
	(56, 35, 2, 20000, 0, 'Unpaid', 'SSL', '2021-12-15', NULL, NULL, NULL, NULL, 'Not Received', NULL, '2021-08-17 20:00:50', '2021-09-01 16:33:47'),
	(57, 35, 3, 12000, 12000, 'Paid', 'Cash', '2022-04-15', '2022-04-15', NULL, NULL, 'INV-000013', 'Received', NULL, '2021-08-17 20:00:50', '2021-09-02 17:10:23'),
	(58, 36, 1, 20000, 20000, 'Paid', 'SSL', '2021-08-18', '2021-08-18', NULL, NULL, 'INV-000012', 'Not Received', NULL, '2021-08-18 10:57:17', '2021-09-02 02:40:58'),
	(64, 39, 1, 20000, 20000, 'Paid', 'SSL', '2021-09-08', '2021-09-08', NULL, '61385d54ac77c', 'INV-000015', 'Received', NULL, '2021-09-08 01:55:51', '2021-09-08 06:51:26'),
	(65, 39, 2, 20000, 20000, 'Paid', 'SSL', '2022-05-01', '2021-09-08', NULL, '6138613dd1ab7', 'INV-000016', 'Received', NULL, '2021-09-08 01:55:51', '2021-09-08 07:08:05'),
	(66, 39, 3, 10000, 10000, 'Paid', 'Cash', '2022-09-01', '2022-09-01', NULL, 'jh65456', 'INV-000014', 'Received', NULL, '2021-09-08 01:55:51', '2021-09-08 02:01:49'),
	(67, 40, 1, 20000, 0, 'Unpaid', 'Cash', '2021-09-13', NULL, NULL, NULL, NULL, 'Received', NULL, '2021-09-13 14:35:43', '2021-09-13 14:35:43'),
	(72, 45, 1, 55000, 55000, 'Paid', 'SSL', '2021-09-15', '2021-09-15', NULL, '61414bed35707', 'INV-000017', 'Received', NULL, '2021-09-15 01:26:52', '2021-09-15 01:54:04'),
	(73, 46, 1, 44000, 44000, 'Paid', 'SSL', '2021-09-15', '2021-09-15', NULL, '61415412ce6a2', 'INV-000018', 'Received', NULL, '2021-09-15 02:01:36', '2021-09-15 02:02:24'),
	(74, 47, 1, 44000, 44000, 'Paid', 'SSL', '2021-09-15', '2021-09-15', NULL, '614154c56405d', 'INV-000019', 'Received', NULL, '2021-09-15 02:04:22', '2021-09-15 02:05:37'),
	(76, 49, 1, 20000, 20000, 'Paid', 'Cash', '2021-09-15', '2021-09-15', NULL, NULL, 'INV-002000', 'Received', NULL, '2021-09-15 02:52:27', '2021-09-15 03:07:06'),
	(77, 50, 1, 20000, 20000, 'Paid', 'SSL', '2021-09-18', '2021-09-18', NULL, '61458da26ea8f', 'INV-002001', 'Received', NULL, '2021-09-18 06:34:20', '2021-09-18 06:57:14');
...
INSERT INTO `units` (`id`, `unit_code`, `name`, `glh`, `credit_hour`, `tut`, `assessment_type`, `status`, `created_at`, `updated_at`) VALUES
	...
	(25, '456456', 'fsd f', '45', 5, 6, 'Internal', 'Active', '2021-09-01 10:02:20', '2021-09-01 10:02:20');
...
-- Dumping data for table abpdb.users: ~14 rows (approximately)
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `email`, `user_profile_image`, `contact_no`, `remarks`, `student_id`, `status`, `type`, `login_status`, `password`, `email_verified_at`, `remember_token`, `created_at`, `updated_at`) VALUES
	(1, 'Momit', 'Hasan', 'momit@technolife.ee', '1616308888.jpg', '74645564654', NULL, NULL, 1, 'Admin', 0, '$2y$10$zFj3Z1gRkrbgUvoNXF6cXubdAp8p54yy4kRgJ421RQNqllCEvHJka', NULL, NULL, '2021-06-07 12:50:15', '2021-09-18 05:31:52'),
	...
	(28, 'Litu', NULL, 'litu@gmail.com', NULL, '646465', NULL, 32, 1, 'Student', 0, '$2y$10$5Z7y7Bt1TDrjp.mtolCSBu.MOayoHhvtMQmLIPV6eLywYVo2XtGGy', NULL, NULL, '2021-08-16 15:37:45', '2021-09-01 12:13:14'),
	...
	(35, 'Maariz Hasan', NULL, 'maariz@gmail.com', '1631945533.jpg', '323213133', NULL, 38, 1, 'Student', 0, '$2y$10$TQ/EjJaWWwH/q4EveSFl5.fW3aIm1zVCaA6isMmtjFiU/8Nf9oHFO', NULL, NULL, '2021-09-08 01:45:47', '2021-09-19 01:23:18'),
	(36, 'MMM', NULL, 'mm@mm.com', NULL, '54645', NULL, 39, 1, 'Student', 1, '$2y$10$P8KteUhsXudRtpfkfq58FuYmVEL6SgZ04cv/L6rk7vn1R3NpbnNEi', NULL, NULL, '2021-09-14 12:12:03', '2021-09-15 02:13:28'),
	(37, 'nnnn', NULL, 'nn@nn.nn', NULL, '6465465', NULL, 40, 1, 'Student', 0, '$2y$10$7WKN4pOShBPyFR6.Au2VBuAo2sI5ASAhhvY3vPo3/uuSb.JXcQwg2', NULL, NULL, '2021-09-14 12:14:57', '2021-09-15 09:35:59'),
...
-- Dumping data for table abpdb.user_group_members: ~20 rows (approximately)
...
-- Dumping data for table abpdb.user_group_permissions: ~234 rows (approximately)
