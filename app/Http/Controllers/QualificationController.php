	...
	public function showList(){
	   ...
	   $qualifications = Qualification::with('units')->with('level')
        ...
        foreach($qualifications as $qualification){
			...
			$data['actions'] =" <button title='View' onclick='qualificationView(".$qualification->id.")' id='view_" . $qualification->id . "' class='btn btn-xs btn-info btn-hover-shine' ><i class='lnr-eye'></i></button>&nbsp;";
		   if($edit_permisiion>0){
                $data['actions'] .="<button onclick='qualificationEdit(".$qualification->id.")' id=edit_" . $qualification->id . "  class='btn btn-xs btn-hover-shine  btn-primary' ><i class='lnr-pencil'></i></button>";
            }
            if ($delete_permisiion>0) {
                $data['actions'] .=" <button onclick='qualificationDelete(".$qualification->id.")' id='delete_" . $qualification->id . "' class='btn btn-xs btn-hover-shine btn-danger'><i class='fa fa-trash'></i></button>";
            }
