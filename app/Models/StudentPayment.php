            ...
            if($validation->fails()){
                ...
                if($studentPayment->update()){
                  ...
                  if($studentPayment->enrollment->status == 'Inactive'){
                    ...
                    $lastEnrollmentIdSQL    = DB::select("SELECT Max(SUBSTR(student_enrollment_id,-3,3)) as max_enrollmen_id FROM batch_students where student_enrollment_id != '' AND batch_id=".$enrollment->batch->id);
