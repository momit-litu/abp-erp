...
{
    protected $fillable = [
        'name', 'email', 'student_no', 'contact_no','emergency_contact',  'address','date_of_birth','nid_no','user_profile_image','remarks','status','study_mode','type','register_type','registration_completed','current_emplyment','current_designation','last_qualification','how_know','passing_year'
    ];
