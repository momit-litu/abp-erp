						...
						<div class="tab-pane `+active+`" id="tab-`+batch_student['id']+`" role="tabpanel">
							<div class="row">
								...
								<div class="col-md-8">
									...
									<button class="btn btn-info  email-button-lg btn-lg" style="" onclick="emailRevisedPayment(`+batch_student['id']+`)"><i class="fa fa-envelope"></i> Send Revised Email </button>
									</div>
								</div>							
							</div>
						</div>
